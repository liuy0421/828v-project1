% This is a slightly modified from Prof. Cameron's SINewton code
% in order to take in batch_size information.
function [w,f,normgrad,runtime] = SINewton_mod(fun,gfun,Hvec,Y,w,bsz)
rho = 0.1;
gam = 0.9;
